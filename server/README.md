...
adapters remain separate. A checkpointed LangGraph runtime boundary is under
development; production integration and multi-agent handoff remain planned. See
